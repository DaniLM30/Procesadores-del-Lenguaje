...
public class TSimb_CSV_Avanzado {
    ...
    /**
     * Metodo que se encarga de a�adir una columna nueva a la lista de columnas del
    ...
    /**
     * M�todo para crear tantas filas como sean necesarias si no hay suficientes
    ...
    public void addValue(int p_fila, String p_columna, String p_valor) {
        ...
        // A�adimos los datos en la fila que me han pedido
        _filas.get(p_fila - 1).put(p_columna, p_valor);
    }
    
    /**
     * M�todo que introduce datos de una celda segun su indice de fila,columna
     * 
    ...
    public void addValue(int p_fila, int p_columna, String p_valor) {
        // Hacemos uso del m�todo de introduccion de datos
    ...
    public String toString() {
        ...
        sb.append("\nTabla de simbolos CSV:\r\n"); //El sb.append sirve para introducir cosas en un StringBuffer
